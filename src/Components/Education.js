          ...
          <div className='-ml-2'>
            <div className='py-4 flex'>
              ...
              <div className='ml-8'>
                ...
                <h6 class='text-sm'>BSc Computer Science (Year in Industry)</h6>
            ...
            <div className='py-4 flex'>
              ...
              <div className='ml-8'>
                <div className='mt-1.5 flex items-baseline'>
                  <h6 class='font-semibold'>
                    Sri Chaitanya{' '}
                    <span className='hidden lg:contents'>Junior College</span>
                  </h6>
            ...
            <div className='py-4 flex'>
              ...
              <div className='ml-8'>
                <div className='mt-1.5 flex items-baseline'>
                  <h6 class='font-semibold'>
                    Gowtham <span className='hidden lg:contents'>Concept</span>{' '}
                    School
                  </h6>
